import fs from 'fs';
import type { ResponseLike } from 'tokenrouter/internal/to-file';
import { toFile } from 'tokenrouter/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('tokenrouter/core/uploads');
    await expect(
